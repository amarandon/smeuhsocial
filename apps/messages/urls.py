...
urlpatterns = [
    ...
    url(r'^compose/(?P<recipient>[\+\w]+)/$', views.compose,
        name='messages_compose_to'),
    url(r'^reply/(?P<message_id>[\d]+)/$', views.reply,
        name='messages_reply'),
    url(r'^view/(?P<message_id>[\d]+)/$', views.view,
        name='messages_detail'),
    url(r'^delete/(?P<message_id>[\d]+)/$', views.delete,
        name='messages_delete'),
    url(r'^undelete/(?P<message_id>[\d]+)/$', views.undelete,
